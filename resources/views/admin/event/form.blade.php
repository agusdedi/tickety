          ...
          <div class="px-4 py-5 bg-white sm:p-6">
            <form method="POST"
              ...
              <div class="mb-6">
                ...
                <textarea name="description" class="bg-gray-50 border border-gray-300 rounded-lg w-full p-2.5">{{ isset($event) ? 
                    $event->description : old('description') }}</textarea>
                {{-- <input type="text" name="description" class="bg-gray-50 border border-gray-300 rounded-lg w-full p-2.5"
                       value="{{ isset($event) ? $event->description : old('description') }}">  --}}
              </div>
              <div class="mb-6">
                <label for="start_time" class="block mb-2 text-sm">Start Date</label>
              ...
              <div class="mb-6">
                <label for="location" class="block mb-2 text-sm">Location</label>
              ...
              <div class="mb-6">
                <label for="duration" class="block mb-2 text-sm">Duration (hour)</label>
